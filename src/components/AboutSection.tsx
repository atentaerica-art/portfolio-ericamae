          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-4 text-muted-foreground">
              ...
              <p>
                ...
                and creating powerful automation workflows using Make.com and Zapier. More recently, 
                I've added Claude Code to my toolkit, letting me build and ship full AI-powered web 
                apps — from client SaaS products to internal automation dashboards — faster than ever. 
                I believe in crafting solutions that not only look beautiful but also drive real results.
              </p>
              <p>
