import { Code, Workflow, Settings, Zap, Sparkles, ArrowRight } from "lucide-react";
...
const services = [
  {
    ...
    description:
      "Full web applications and SaaS products built and shipped using Claude Code — from client onboarding flows to admin dashboards with AI-powered features baked right in, like automated follow-ups and content pipelines.",
    features: ["Claude Code", "Custom Dashboards", "AI Automation", "Rapid Deployment"],
  },
  {
    icon: Code,
